...
<h2 className='text-white  font-bold md:text-xl p-4'>My Shows</h2>
  ...
  className='bg-white text-black left-0 rounded-full absolute opacity-50 hover:opacity-100 cursor-pointer z-10 hidden group-hover:block' size={40}/>
     ...
     <div id={'slider'} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative' >
        {movies.map((item,id)=> (
             ...
             <div className=' absolute top-0 left-0 w-full h-full hover:bg-black/80  hover:opacity-[100] opacity-0 text-white '>
               <p className='whitesapce-normal text-xs md:text-sm font-bold flex justify-center items-center h-full text-center'>
                   {item?.title}</p>
